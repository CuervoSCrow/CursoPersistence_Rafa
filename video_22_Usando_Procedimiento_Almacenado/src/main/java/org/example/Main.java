...
//            Forma 1 de ejecutar el Store Procedure

//            System.out.println("***** Promocion del curso 2 al 3 con StoreProcedure ******");
//            if(alumnoDB.promocionAlumnos_StoreProcedure(2,3)){
//                System.out.println("La promocion del curso se realizo correctamente");
//            }else
//                System.out.println("Ha ocurrido un error realizando la promocion del curso");

//            Forma 2 de ejecutar el Stored Procedure
            System.out.println("***** Promocion del curso 2 al 3 con StoreProcedure ******");
            if(alumnoDB.promocionAlumnos_StoreProcedure_NamedStoreProcedureQuery(2,3)){
                System.out.println("La promocion del curso se realizo correctamente");
            }else
                System.out.println("Ha ocurrido un error realizando la promocion del curso");
